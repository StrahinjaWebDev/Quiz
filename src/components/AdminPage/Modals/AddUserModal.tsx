...
const AddUserModal = ({
  ...
  return (
    <div
      className={`absolute animation-forwards left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-main min-h-[16em] w-[30em] flex flex-col rounded-xl items-center gap-5 text-secondary border-white border-2 ${
